...
mmtimes = 0  # number of times minimax called
...
import random  # should be moved to top of program by you
...
def reset_game():
    global board, winner, XO, draw, max_depth
    time.sleep(.1)
    XO = 'x'
    draw = False
